  ...
  <div
    ...
    <form action="" method="POST">
      <div class="m-4 flex items-center justify-start gap-8">
        ...
        <input type="text" id="title" name="title" class="w-3/4 rounded-md border-2 p-2">
      </div>
      <div class="m-4 flex items-start justify-start gap-8">
        <label for="content">Content</label>
        <textarea rows="6" name="content" id="content" class="ml-2 w-3/4 rounded-md border-2 p-2"></textarea>
      </div>
      <div class="flex items-center justify-end">
        <button type="submit"
          class="my-2 mr-16 rounded-md border-blue-200 bg-blue-500 px-4 py-2 text-white hover:bg-blue-600">Submit</button>
      </div>
    </form>
  </div>
@endsection
